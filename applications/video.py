...
#model_path = "/home/conex/model/"
model_path = "/home/conex/Yet-Another-Openpose-Implementation/trained/models/test_model10Wed0321-1433"
...
class VideoApp:
    def __init__(self, input_video_file, output_filename, fourcc_str, fps):
        ...
        if not self.video_reader.isOpened():
            raise IOError("Error opening v	ideo file")
